...
<div class="wrapper">
	<h1><a href=""><em>服务器应用监控系统</em></a></h1>
    	...
    	<div class="post">
			...
			<thead>
				<tr class="header">
				<th>设备ID</th><th>主机名称</th><th>CPU主频</th><th>内存总量</th><th>内存使用数量</th>
				<th>磁盘总量</th><th>磁盘剩余量</th><th>单位时间流入量</th><th>单位时间流出量</th><th>最后登录用户</th><th>最后登录时间</th><th>入库时间</th>
				</tr>
			</thead>
			<tbody> 
				<s:iterator value="listZtzj">
				<tr>
					<td><s:property value="Sbid"/></td>
					<td><s:property value="Zjmc"/></td>
					<td><s:property value="Zp"/></td>
					<td><s:property value="Zl"/></td>
					<td><s:property value="Sysl"/></td>
					<td><s:property value="Cpzl"/></td>
					<td><s:property value="Cpsyl"/></td>
					<td><s:property value="Lrl"/></td>
					<td><s:property value="Lcl"/></td>
					<td><s:property value="Zhdlyh"/></td>
					<td><s:property value="Zhdlsj"/></td>
...
<footer>
    <p class="copyright">
        Copyright &copy; <a href="index.jsp">2013 孟令伟</a> | Collect Form <a href="#" title="服务器应用监控系统">服务器应用监控系统</a>
    </p>
</footer>
</body>
</html>
