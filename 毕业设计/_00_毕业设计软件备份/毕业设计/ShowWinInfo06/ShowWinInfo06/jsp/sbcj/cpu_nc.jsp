...
<div class="wrapper">
	<h1><a href=""><em>服务器应用监控系统</em></a></h1>
    	...
    	<div class="post">
			...
			<thead>
				<tr class="header">
				<th>设备ID</th><th>CPU个数</th><th>CPU主频</th><th>CPU使用率</th><th>内存总量</th><th>内存使用数量</th><th>内存剩余量</th><th>内存使用率</th><th>采集时间</th><th>入库时间</th>
				</tr>
			</thead>
			<tbody> 
				<s:iterator value="listCpu_nc">
				<tr>
					<td><s:property value="Sbid"/></td>
					<td><s:property value="Gs"/></td>
					<td><s:property value="Zp"/></td>
					<td><s:property value="Cpu_Syl"/></td>
					<td><s:property value="Zl"/></td>
					<td><s:property value="Sysl"/></td>
					<td><s:property value="Ncsy"/></td>
					<td><s:property value="Nc_Syl"/></td>
