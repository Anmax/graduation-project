...
<div class="wrapper">
	<h1><a href=""><em>服务器应用监控系统</em></a></h1>
    	...
    	<div class="post">
			...
			<thead>
				<tr class="header">
				<th>设备ID</th><th>登录用户名</th><th>登陆时间</th><th>客户端IP</th><th>操作命令</th><th>退出时间</th><th>采集时间</th><th>入库时间</th>
				</tr>
			</thead>
			<tbody> 
				<s:iterator value="listYhcz">
				<tr>
					<td><s:property value="Sbid"/></td>
					<td><s:property value="Yhm"/></td>
					<td><s:property value="Dlsj"/></td>
					<td><s:property value="IP"/></td>
					<td><s:property value="Ml"/></td>
					<td><s:property value="Tcsj"/></td>
