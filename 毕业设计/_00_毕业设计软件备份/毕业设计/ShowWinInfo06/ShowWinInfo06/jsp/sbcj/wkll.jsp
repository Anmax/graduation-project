...
<div class="wrapper">
	<h1><a href=""><em>服务器应用监控系统</em></a></h1>
    	...
    	<div class="post">
			...
			<thead>
				<tr class="header">
				<th>设备ID</th><th>网卡名称</th><th>IP地址</th><th>单位时间流入量</th><th>单位时间输入丢包数</th><th>单位时间输入错包数</th><th>单位时间流出量</th><th>单位时间输出丢包数</th><th>单位时间输出错包数</th><th>采集时间</th><th>入库时间</th>
				</tr>
			</thead>
			<tbody> 
				<s:iterator value="listWkll">
				<tr>
					<td><s:property value="Sbid"/></td>
					<td><s:property value="Wkmc"/></td>
					<td><s:property value="IP"/></td>
					<td><s:property value="Lrl"/></td>
					<td><s:property value="Srdbs"/></td>
					<td><s:property value="Srcbs"/></td>
					<td><s:property value="Lcl"/></td>
					<td><s:property value="Scdbs"/></td>
					<td><s:property value="Sccbs"/></td>
